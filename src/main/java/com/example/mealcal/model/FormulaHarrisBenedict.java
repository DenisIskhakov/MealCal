...
//    public void getBasalMetabolicRate(CalorieCalculation calorieCalculation){
...
//    public void getSupport(CalorieCalculation calorieCalculation){
...
//    public void getCalorieDeficit(CalorieCalculation calorieCalculation){
//        //=ЕСЛИ(($B$25-$B$25*B11)<1200;1200;$B$25-$B$25*B11)
//        if((this.getSupport()-this.getSupport()*calorieCalculation.getPercentageSurplusOrDeficit().getPercentageSurplusOrDeficit())<1200){
//            this.setSupport(1200.0);
//        }else{
...
//    //Нужно указать в переменную процент дефецита/профицита(10-15-20)
//    public void getCalorieSurplus(CalorieCalculation calorieCalculation){
//        this.setCalorie_surplus(this.getSupport()+this.getSupport()*calorieCalculation.getPercentageSurplusOrDeficit().getPercentageSurplusOrDeficit());
//    }
//}
